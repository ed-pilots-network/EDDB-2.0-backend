...
public interface MybatisLocateSingleHopTradeRouteRepository {
    ...
    @Results(id = "findSingleHopTradeResultMap", value = {
            ...
            @Result(property = "distanceFromReferenceStation", column = "distance_from_reference", javaType = Double.class)
    })
    List<MybatisSingleHopEntity> locateRoutesByFilter(MybatisLocateSingleHopTradeFilter locateSingleHopTradeFilter);
}
