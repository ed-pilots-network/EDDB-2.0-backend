...
public class FindSystemsByNameContainingUseCaseTest {
    ...
    @Test
    void testFindSystemsByNameContaining_shouldThrowOnValidationError() {
    ...
    @Test
    void testFindSystemsByNameContaining_shouldReturnListOfSystemDto() {
        ...
        when(loadSystemsByNameContainingPort.loadSystemsByNameContaining(subString, amount)).thenReturn(List.of(system1, system2));
